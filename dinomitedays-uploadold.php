    ...
    static public function process_upload($atr)
    {
        ...
        foreach ($_FILES as $key => $fileInfo) {
            ...
            if ($error == UPLOAD_ERR_OK) {
                ...
                if (false === $answer) {
                    $msg .= "$errorBeg E#885 there was a problem in retrieving/move the file $newname $errorEnd ";
                } else {
                    ...
                    if ("coordinates" != $key) {
                        ...
                        if (false === $answer) {
                            $msg .= "$errorBeg E#887 there was a problem in copying the fileto $finalname $errorEnd ";
                        } else {
